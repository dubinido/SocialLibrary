...
public class MyBookAdapter extends RecyclerView.Adapter<MyBookAdapter.ViewHolder>
{
    ...
    LatLng userLoc;
    //constructor
    public MyBookAdapter(List<Book> mbooks,OnBookListener onBookListener, LatLng userLoc) {
        this.books = mbooks;
    ...
    public void onBindViewHolder(MyBookAdapter.ViewHolder viewHolder, int position) {
        ...
        String dis = new DecimalFormat("##.#").format(book.getDistance(userLoc));
        bookDistance.setText(dis+" km away");
